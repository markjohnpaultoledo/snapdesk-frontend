  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        success: {
          DEFAULT: "var(--color-success)", /* teal-600 */
        ...
        trust: {
          DEFAULT: "var(--color-trust)", /* emerald-200 */
          foreground: "var(--color-trust-foreground)", /* gray-900 */
        },
        surface: "var(--color-surface)", /* warm-gray-50 */
        "text-primary": "var(--color-text-primary)", /* gray-900 */
        "text-secondary": "var(--color-text-secondary)", /* gray-500 */
        cta: {
          DEFAULT: "var(--color-cta)", /* teal-700 */
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(74, 155, 155, 0.3)',
